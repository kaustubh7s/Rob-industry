      ...
      items: [
        {
          ...
          roles: ['super_admin', 'admin', 'purchase_manager', 'store_manager', 'operator'],
        },
        {
          id: 'production',
      ...
      items: [
        {
          ...
          icon: Table,
          roles: ['super_admin', 'admin', 'purchase_manager', 'production_manager', 'store_manager', 'accounts', 'operator'],
        },
        {
          id: 'orders',
          ...
          icon: Layers,
          roles: ['super_admin', 'admin', 'production_manager', 'purchase_manager', 'store_manager', 'operator'],
        },
        {
          id: 'materials',
          ...
          icon: Package,
          roles: ['super_admin', 'admin', 'purchase_manager', 'store_manager'],
        },
        {
          id: 'bom',
        ...
        },
        {
          ...
          roles: ['super_admin', 'admin', 'purchase_manager', 'production_manager', 'store_manager'],
        },
      ],
    },
    {
